...
public class ninteenth_activity extends AppCompatActivity implements View.OnClickListener {
TextView tv1,tv2,tv3,tv4,tv5,tv6,tv7,tv8,tv9;
Button btn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ninteenth);
    ...
    public void onClick(View v) {
        Intent next=new Intent(ninteenth_activity.this,twentyfour_activity.class);
        startActivity(next);
    }
}